...
-- Started on 2024-10-31 11:28:31
...
4	consejero del Consejo de Italia
...
SELECT pg_catalog.setval('public.documents_doc_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.office_office_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.persons_person_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.tag_tag_id_seq', 46, true);
...
--
-- TOC entry 4780 (class 2606 OID 17409)
...
--
-- TOC entry 4781 (class 2606 OID 17404)
...
--
-- TOC entry 4782 (class 2606 OID 17399)
...
--
-- TOC entry 4783 (class 2606 OID 17419)
...
--
-- TOC entry 4784 (class 2606 OID 17414)
...
--
-- TOC entry 4786 (class 2606 OID 17370)
...
--
-- TOC entry 4794 (class 2606 OID 17477)
-- Name: persons_documents persons_documents_doc_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.persons_documents
    ADD CONSTRAINT persons_documents_doc_id_fkey FOREIGN KEY (doc_id) REFERENCES public.documents(doc_id);


--
-- TOC entry 4795 (class 2606 OID 17472)
-- Name: persons_documents persons_documents_person_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.persons_documents
    ADD CONSTRAINT persons_documents_person_id_fkey FOREIGN KEY (person_id) REFERENCES public.persons(person_id);


--
-- TOC entry 4788 (class 2606 OID 17383)
...
--
-- TOC entry 4789 (class 2606 OID 17378)
...
--
-- TOC entry 4785 (class 2606 OID 17394)
-- Name: documents type_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.documents
    ADD CONSTRAINT type_id_fk FOREIGN KEY (type) REFERENCES public.doc_types(type);


-- Completed on 2024-10-31 11:28:31
